<template>
    <Layout>
        <div class="gantt-wrap">
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabClick" style="margin-top: 20px">
                <el-tab-pane label="人员" name="first">
                    <div class="table-title">人员</div>
                    <ResourceGanttTable :date="this.date" :queryData="this.personData" :bias="this.bias" :block-size="this.blockSize" :blocks="this.blocks" :body-width="bodyWidth" :date-type="this.dateType"> </ResourceGanttTable>
                </el-tab-pane>
                <el-tab-pane label="设备" name="second">
                    <div class="table-title">设备</div>
                    <ResourceGanttTable :date="this.date" :queryData="this.deviceData" :bias="this.bias" :block-size="this.blockSize" :blocks="this.blocks" :body-width="bodyWidth" :date-type="this.dateType"> </ResourceGanttTable>
                </el-tab-pane>
                <el-tab-pane label="产线" name="third">
                    <div class="table-title">产线</div>
                    <ResourceGanttTable :date="this.date" :queryData="this.lineData" :bias="this.bias" :block-size="this.blockSize" :blocks="this.blocks" :body-width="bodyWidth" :date-type="this.dateType"> </ResourceGanttTable>
                </el-tab-pane>
            </el-tabs>
            <el-popover
                    placement="bottom"
