        ...
        <div class="gantt-wrap">
            ...
            <div class="time-scroll-bar">
                ...
                <div class="time-middle"
                     :style="{'max-width':blocks*blockSize+'px','flex':'0 0 '+(bodyWidth*0.9-48-2*26)+'px'}"
                     @scroll="drag"
                ...
                <el-tab-pane label="人员负载" name="person">
                    <div class="table">
                        <div class="row"  v-for="item in Loaddata.personnelLoad" :key="item.name">
                            ...
                            <div class="row-content" :style="{'width':(bodyWidth*0.9-48-26)+'px','max-width':blocks*blockSize+'px'}">
